...
- **ETDRK4** <Cite key="hochbruck2010exponential" />: a four-stage exponential RK method that achieves fourth order. The Mamba-3 paper does not (yet) use ETDRK4; its second-order exp-trapezoidal is the empirical sweet spot.
