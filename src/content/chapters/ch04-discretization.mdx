...
$$
This is the **bilinear transform**, also called the **Tustin transform** after Arnold Tustin's 1947 paper introducing it in control theory <Cite key="tustin1947method" />. The original S4 paper uses bilinear discretization (S4D supports either bilinear or ZOH); so do many signal-processing toolboxes.
