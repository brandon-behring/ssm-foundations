...
companion-julia-tests:
	@for ch in ch05 ch06 ch07 ch10; do \
		echo "==> $$ch julia tests"; \
...
companion-torch-tests:
	@.venv/bin/pytest companions/ch01/torch companions/ch02/torch companions/ch03/torch companions/ch04/torch companions/ch05/torch companions/ch06/torch companions/ch07/torch companions/ch08/torch companions/ch09/torch companions/ch10/torch -q
